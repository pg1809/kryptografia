...
public class PrimeSieve {
     ...
     */
    private final int MAX_GENERATED_PRIME = 1000000;
    ...
    public Pair generateTwoPrimes(BigNum maximum) {
        ...
        while (primesGenerated < 2) {
            ...
            for (int prime : smallPrimes) {
                // we need to box our small prime into a BigNum
                ...
                while (currentCandidate < SIEVE_SIZE) {
                    ...
                    ++currentCandidate;
                    // when we take the next candidate our remainder grows by 4
                    r += 4;
                }
            ...
            System.out.println("Numbers to check: " + numbersToCheck);
