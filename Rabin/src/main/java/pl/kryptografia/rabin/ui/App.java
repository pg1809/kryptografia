...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Pair result = sieve.generateTwoPrimes(initialCandidate);

        BigInteger A = new BigInteger(result.first.toString(), 2);
        BigInteger B = new BigInteger(result.second.toString(), 2);
